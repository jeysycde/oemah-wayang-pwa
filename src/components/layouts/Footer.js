        ...
        <div className="container px-6 py-4 mx-auto">
          <div className="flex">
            <div className="w-full -mx-6 lg:w-2/5">
              <div className="px-6">
                <div className="flex gap-4">
                  <img
                    className="w-12 h-12"
                    src={process.env.PUBLIC_URL + "/icons/icon-no-bg.png"}
                    alt="Icon"
                  />
                  <a
                    href="#"
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
              <div className="hidden md:grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
                <div></div>
                <div>
          ...
          <div>
            <p className="text-center text-gray-800">
              © Exova Dewata {new Date().getFullYear()} - All rights reserved
            </p>
          </div>
        </div>
      </footer>
